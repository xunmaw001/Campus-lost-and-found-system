...
var centerMenu = [
    ...
    ,{
        name: '失物认领',
        url: '../shiwuYuyue/list.html'
    },
    {
        name: '失物招领',
        url: '../shiwu/list2.html'
    }
    ,{
        name: '寻物认领',
        url: '../xunwuYuyue/list.html'
    }
    ,{
        name: '寻物启示',
        url: '../xunwu/list2.html'
    }
...
var indexNav = [
    ...
    {
        name: '失物招领',
        url: './pages/shiwu/list.html'
    },
    {
        name: '寻物启示',
        url: './pages/xunwu/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/xiaoyaunshiwuzhaolingxitong/admin/dist/index.html#/login";
